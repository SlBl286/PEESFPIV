...
public class KeyFocusConfigurations : IEntityTypeConfiguration<KeyFocus>
{
    public void Configure(EntityTypeBuilder<KeyFocus> builder)
    {
        ConfigureUserTable(builder);
    }
    private void ConfigureUserTable(EntityTypeBuilder<KeyFocus> builder)
    {
        builder.ToTable("KeyFocus");
